...
if(ACTION=="test"){
    ...
    $database_obj->connect();
		...
		api_alerts_add(api_tag("strong",api_text("cDatabasesDatasource-danger-connection"))."<br>".$e->getMessage(),"danger");
	}
}
...
require_once(MODULE_PATH."datasources_view-informations.inc.php");
					 ...
					 * @var cDatabasesDatasourceMember $selected_member_obj
					 */
					//require_once(MODULE_PATH."datasources-view-members.inc.php");
// build tabs
$tab=new strTab();
$tab->addItem(api_icon("fa-flag-o")." ".api_text("datasources_view-tab-informations"),$informations_dl->render(),("informations"==TAB?"active":null));
					//$tab->addItem(api_icon("fa-users")." ".api_text("datasources-view-tab-members"),$members_table->render(),("members"==TAB?"active":null));
